      ...
      <div className="pt-24 sm:pb-12 sm:pt-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-xl text-center">
            <HeroText>
              {props.title || "AI Made Easy for Everyone."}
            </HeroText>
            <HeroSubtitle>
              {props.subtitle ||
                "Your ultimate platform to explore AI models by task, domain, company, and country. Dive deeper with insightful blogs and expert reviews."}
            </HeroSubtitle>
            <CTAButtons />
          </div>
