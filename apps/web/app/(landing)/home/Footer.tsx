...
const navigation = {
  main: [
    { name: "Top AI Models by Domain", href: "/bulk-email-unsubscriber" },
    { name: "Top AI Models by Company", href: "/block-cold-emails" },
    { name: "Top AI Models by Country", href: "/email-analytics" },
    ...
    <footer className="relative z-50">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; {new Date().getFullYear()} AI PortalX. All rights reserved.
        </p>
      </div>
    </footer>
  );
...
function FooterList(props: {
  ...
  return (
    <>
      <h3 className="text-sm font-semibold leading-6">{props.title}</h3>
        ...
        {props.items.map((item) => (
          <li key={item.name}>
            <Link
              ...
              className="text-sm leading-6 text-gray-600 hover:underline"
            >
              {item.name}
            </Link>
          </li>
