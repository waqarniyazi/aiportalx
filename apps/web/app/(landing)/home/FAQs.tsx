const faqs = [
  ...
  },
  {
    ...
    answer: "You can filter models by task (e.g., image recognition), domain (e.g., healthcare), company, and country using our intuitive filtering options."
  },
  {
    question: "Are the AI models free to use?",
    answer: "While some models are free, others may require subscriptions or licenses. Each model page provides detailed pricing and access information."
  },
  {
  ...
  },
  {
    ...
    answer: "Our database and blog are updated regularly to ensure users access the latest information and trends."
  },
];
